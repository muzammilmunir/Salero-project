    ...
    return (
        <>
            <>
                ...
                <td>
                    <input type="number" required="required" placeholder="Enter a mobile" name="mobile"
                ...
                <td>
                    <div className="d-flex">
                        <button className="btn btn-warning shadow btn-xs sharp me-1" type="submit"><i className="las la-check-circle scale5" /></button>
