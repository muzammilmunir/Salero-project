...
import { buttongroupsidebarLink } from "../../constant/alldata";
import { Row, Col, Card, Button, ButtonGroup, Dropdown, DropdownButton, Tab, Nav } from "react-bootstrap";
          ...
          <div className="demo-right ">
            <div className="demo-right-inner dlab-scroll " id="right-sidebar">
              ...
              <ul className="navbar-nav" id="menu-bar">
                {buttongroupsidebarLink.map((item, ind) => (
                  <li key={ind}
                  >
