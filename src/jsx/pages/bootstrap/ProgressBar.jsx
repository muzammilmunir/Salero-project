...
import { progessbarsidebarLink, progressBarData } from "../../constant/alldata";
                  ...
                  <Tab.Container defaultActiveKey="Preview">
                    <Card name="different-bar" className="dz-card">
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            {progressBarData.map((data, i) => i !== progressBarData.length - 1 && <ProgressBar now={data.value} variant={data.variant} key={i} className="mt-3" />)}
                          </Card.Body>
                        </Tab.Pane>
                        <Tab.Pane eventKey="Code">
                          <div className="card-body pt-0 p-0 code-area">
                  ...
                  <Tab.Container defaultActiveKey="Preview">
                    <Card name="animated-striped" className="dz-card">
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            {progressBarData.map((data, i) => i !== progressBarData.length - 1 && <ProgressBar now={data.value} variant={data.variant} key={i} className="mt-3" striped />)}
                          </Card.Body>
                        </Tab.Pane>
                        <Tab.Pane eventKey="Code">
                          <div className="card-body pt-0 p-0 code-area">
          ...
          <div className="demo-right ">
            <div className="demo-right-inner dlab-scroll " id="right-sidebar">
              ...
              <ul className="navbar-nav" id="menu-bar">
                {progessbarsidebarLink.map((item, ind) => (
                  <li key={ind}>
                    <Link to={item.to} smooth={true} className={`scroll ${ind === activeLink ? "active" : ""} `} activeClass="active" spy={true} onClick={() => setActiveLink(ind)}>
                      {item.title}
                    </Link>
                  </li>
                ))}
