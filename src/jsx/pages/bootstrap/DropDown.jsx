...
import { Row, Col, Card, Dropdown, DropdownButton, ButtonGroup, SplitButton, Tab, Nav } from "react-bootstrap";
import { dropdownsidebarLink } from "../../constant/alldata";
          ...
          <div className="demo-right ">
            <div className="demo-right-inner dlab-scroll " id="right-sidebar">
              ...
              <ul className="navbar-nav" id="menu-bar">
                {dropdownsidebarLink.map((item, ind) => (
                  <li key={ind}
                  >
                    <Link to={item.to}
