...
import { cardBlog, commentsblog, postDetial, seoToolsData, thirdPostBlog, usersDetial } from '../../constant/alldata';
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-12">
                                        <div className="blog-img">
                                            ...
                                            <div className="blog-text">
                                                ...
                                                {" "}<span>Hary in February 05, 2025</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-12">
                                                ...
                                                <div className="post-1" key={index}>
                                                    ...
                                                    <div className="post-data">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span><b className="text-primary">{item.name}</b> in {item.date}, 2025</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ))}
