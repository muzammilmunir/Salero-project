									...
									<div className="col-xl-12">
										<div className="auth-form">
											...
											<form onSubmit={onSignUp}>
												<div className="mb-3">
													<label className="form-label"><strong>Username</strong> <span className='required'>*</span></label>
													<input type="text" className="form-control" placeholder="username" />
												</div>
												<div className="mb-3">
													<label className="form-label"><strong>Email</strong> <span className='required'>*</span></label>
												...
												<div className="mb-3">
													<label className="form-label"><strong>Password</strong> <span className='required'>*</span></label>
													<input
														value={password}
														onChange={(e) =>
