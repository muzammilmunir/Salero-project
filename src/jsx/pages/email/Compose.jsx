									...
									<div className="col-xl-3 col-xxl-3 col-lg-3">
										<div className="email-left-box dz-scroll pt-3 ps-0">
											<div className="p-0">
												...
												>
													<i className="fa-solid fa-plus me-2" />Compose Email
												</Link>
											</div>
											<div className="mail-list rounded ">
												...
												<Link to="/email-compose" className="list-group-item">
													<i className="fa-regular fa-paper-plane align-middle" />
													Sent
												</Link>
												<Link to="/email-compose" className="list-group-item">
													<i className="fa-regular fa-star align-middle" />
													Favorite
												</Link>
												<Link to="/email-compose" className="list-group-item">
													<i className="fa-regular fa-file align-middle" />
													Draft
												</Link>
												<Link to="/email-compose" className="list-group-item">
										...
										<div className="email-right-box ms-0">
											...
											<div className="compose-wrapper mt-3" id="compose-content">
												<div className="compose-content">
													...
													<h5 className="my-3"><i className="fa fa-paperclip me-2" /> Attatchment</h5>														
