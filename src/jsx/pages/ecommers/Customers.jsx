                           ...
                           <table className="table mb-0 table-striped">
                              ...
                              <tbody id="customers">
                                 <tr className="btn-reveal-trigger">
                                    ...
                                    <td className="py-2">30/03/2025</td>
                                 ...
                                 <tr className="btn-reveal-trigger">
                                    ...
                                    <td className="py-2">11/07/2025</td>
                                    <td className="py-2 text-right">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                    ...
                                    <td className="py-2">05/04/2025</td>
                                    <td className="py-2 text-right">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                 ...
                                 <tr className="btn-reveal-trigger">
                                    ...
                                    <td className="py-2">17/03/2025</td>
                                    <td className="py-2 text-right">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                    ...
                                    <td className="py-2">12/07/2025</td>
                                    <td className="py-2 text-right">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                    ...
                                    <td className="py-2">15/06/2025</td>
                                    <td className="py-2 text-right">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
