										...
										<Tab.Container defaultActiveKey="first">
											<Tab.Content>
												<Tab.Pane eventKey="first">
													<img className="img-fluid rounded" src={IMAGES.Product1} alt="" />
												</Tab.Pane>
												<Tab.Pane eventKey="second">
													<img className="img-fluid rounded" src={IMAGES.Product2} alt="" />
												</Tab.Pane>
												<Tab.Pane eventKey="third">
													<img className="img-fluid rounded" src={IMAGES.Product3} alt="" />
												</Tab.Pane>
												<Tab.Pane eventKey="four">
													<img className="img-fluid rounded" src={IMAGES.Product4} alt="" />
												</Tab.Pane>
											</Tab.Content>
												...
												<Nav as="ul" className="nav slide-item-list mt-3" role="tablist">
													<Nav.Item as="li">
														<Nav.Link as="a" eventKey="first" to="#first">
															<img className="img-fluid" src={IMAGES.listImg01} alt="" width={50} />
														</Nav.Link>
													</Nav.Item>
													<Nav.Item as="li">
														<Nav.Link as="a" eventKey="second" to="#second">
															<img className="img-fluid" src={IMAGES.listImg02} alt="" width={50} />
														</Nav.Link>
													</Nav.Item>
													<Nav.Item as="li">
														<Nav.Link as="a" eventKey="third" to="#third">
															<img className="img-fluid" src={IMAGES.listImg03} alt="" width={50} />
														</Nav.Link>
													</Nav.Item>
													<Nav.Item as="li">
														<Nav.Link as="a" to="#for" eventKey="four">
															<img className="img-fluid" src={IMAGES.listImg04} alt="" width={50} />
														</Nav.Link>
													</Nav.Item>
												</Nav>
											</div>
									...
									<div className="col-xl-9 col-lg-6  col-md-6 col-sm-12">
										<div className="product-detail-content">
											...
											<div className="new-arrival-content pr">
												<h4>BBQ Pulled Pork Sandwich</h4>
												...
												<p>
													Product tags:&nbsp;&nbsp;
													<span className="badge badge-success light me-1">tasty</span>
													<span className="badge badge-danger light me-1"> foodpics </span>
													<span className="badge badge-info light me-1"> love </span>
													<span className="badge badge-warning light me-1"> foodies</span>
												</p>
