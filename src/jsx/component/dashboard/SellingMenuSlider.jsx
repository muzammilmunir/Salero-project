                ...
                <SwiperSlide className="swiper-slide" key={index}>
                    <div className="card">
                        ...
                        <div className="media-data card-footer order-now">
                            <div className="d-flex justify-content-between align-items-baseline">
                                <div>
                                    <span><i className="fa-solid fa-location-dot me-2" />Bristol, Bristol</span>
                                    <div>
                                        <span className="me-1"><i className="fa-solid fa-bicycle me-2" />{15 + index} Min</span>
                                        <span className="ms-1"><i className="fas fa-bell me-2" />{18 + index} Min</span>
